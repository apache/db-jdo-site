...
later. Please refer to link:state_transition.adoc[Object Lifecycle] for
...
This acts as an instruction to the link:enhancement.adoc[enhancement
...
the current link:fetchgroups.adoc[Fetch Group] for that class for that
_PersistenceManager_.
* By default the fields of the object that will be detached are those in
the _Default Fetch Group_.
* You should choose your link:fetchgroups.adoc[Fetch Group] carefully,
