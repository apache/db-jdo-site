...
link:pmf.adoc[PersistenceManagerFactory] for the datastore.

The simplest way of creating a _PersistenceManager_
link:api20/apidocs/javax/jdo/PersistenceManager.adoc[image:images/javadoc.png[image]]
is as follows
...
using link:metadata.adoc[MetaData (XML/Annotations)]. Then you would
...
As we have seen in the link:state_transition.adoc[JDO States guide], an
