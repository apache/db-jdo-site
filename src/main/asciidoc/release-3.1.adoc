...
https://www.apache.org/dyn/closer.lua/db/jdo/3.1/jdo-3.1-source-release.zip[3.1 source-release.zip]
...
https://www.apache.org/dyn/closer.lua/db/jdo/3.1/jdo-3.1-src.tar.gz[3.1 src.tar.gz]
